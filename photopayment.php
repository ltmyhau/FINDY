...
<?php 
    ...
    $connect = new connect;
    $select_dathanhtoan = $connect -> select_dathanhtoan($id_tho); //
...
<div class="row">
<?php
                                    if($select_dathanhtoan){
                                        while($result = $select_dathanhtoan->fetch_assoc()){
            ...
            <div class="order">
                ...
                <div class="order__info">
                    <span class="order__title">
                        Mã đơn hàng:
                        <strong><?php echo $mathanhtoan ?> </strong>
                    </span>
                    <span class="order__title">
                        Phong cách:
                ...
                <div class="order__info">
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <button class="btn order-btn">Đã được thanh toán</button>
                                    </form>
                </div>

                <a href="<?php echo $drive ?> " target="self" class="order__detail">
                    Xem chi tiết
